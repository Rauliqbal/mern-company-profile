...
export default function CreateService() {
  ...
  const {createService, service} = useServiceStore()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = (error as any).response?.data?.message || "Failed to save service.";
          ...
          <div className="space-y-2">
            ...
            {file ? (
              ...
              >
                ...
                <p className="text-xs text-gray-500 text-center">JPG, PNG, SVG or WEBP (MAX. 800x400px)</p>
              </div>
            )}
          </div>
